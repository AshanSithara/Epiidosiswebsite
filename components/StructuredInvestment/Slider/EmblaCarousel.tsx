...
const EmblaCarousel: React.FC<PropType> = ({ slides, options }) => {
  ...
  return (
    <>
    <section className="embla p-6 flex flex-col gap-6 font-montserrat w-[1200px]">
      <h2 className="text-center text-3xl md:text-4xl textgold"style={{
      fontFamily: "Montserrat, sans-serif",
    }}>
        Use Cases
      </h2>
      <p className="text-center text-gray-600 mb-8 md:mx-60">The following are some practical use cases demonstrating how Epiidosis Investments' structured financing expertise can be used.</p>
