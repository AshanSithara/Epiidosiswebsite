  ...
  return (
    ...
    <section className="py-12 my-12 bg-white relative">
      <div className="container mx-auto text-center">
        <h2
          className="text-4xl md:text-3xl textgold mb-8"
          style={{
        ...
        <div className="overflow-hidden relative marquee-container">
          ...
          {/* Left Gradient */}
          <div className="absolute left-0 top-0 h-full w-72 bg-gradient-to-r from-white to-transparent pointer-events-none gradient-left"></div>
          {/* Right Gradient */}
          <div className="absolute right-0 top-0 h-full w-72 bg-gradient-to-l from-white to-transparent pointer-events-none gradient-right"></div>
        </div>
      </div>
